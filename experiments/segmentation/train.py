...
class Options():
    def __init__(self):
        parser = argparse.ArgumentParser(description='Michelangelo: Segmentation')
        # model and dataset 
        parser.add_argument('--model', type=str, default='encnet',
                            help='model name (default: encnet)')
        parser.add_argument('--backbone', type=str, default='resnet50',
                            help='backbone name (default: resnet50)')
        parser.add_argument('--dataset', type=str, default='tnscui',
...
class Trainer():
    def __init__(self, args):
        ...
        input_transform = transform.Compose([
            transform.Resize(256, interpolation=2),
            transform.ToTensor(),
